...
export const perfectionist = async (options: Readonly<OptionsPerfectionist>): Promise<TypedFlatConfigItem[]> => {
    const { overrides } = options;

    const [perfectionistPlugin] = await loadPackages(['eslint-plugin-perfectionist']);
